...
INSERT INTO EMPLOYEE_BLANK(ID, NAME, SERNAME, FATHER_NAME, EMAIL, TELEFONE_NUMBER, INFORMATION, PRIKAZ) VALUES
(3, 'Александр', 'Хопта', 'Петрович', 'sasha@.ru', '(2-20-47)', 'Дата рождения: 10.07.1987. Увлечения: плавание','Номер распоряжения: 202');
INSERT INTO EMPLOYEE_BLANK(ID, NAME, SERNAME, FATHER_NAME, EMAIL, TELEFONE_NUMBER, INFORMATION, PRIKAZ) VALUES
(4, 'Владимир', 'Никифоров', 'Александрович', 'vova@rambler.ru', '2-45-48', 'Дата рождения: 12.07.1967','Номер приказа: 404');
INSERT INTO EMPLOYEE_BLANK(ID, NAME, SERNAME, FATHER_NAME, EMAIL, TELEFONE_NUMBER, INFORMATION, PRIKAZ) VALUES
(5, 'Семен', 'Лобанов', 'Иванович', 'semen@yandex.com', '8(777)654-12-21', 'Дата рождения: 10.01.1987. Увлечения: борьба','Номер приказа: 15');
INSERT INTO EMPLOYEE_BLANK(ID, NAME, SERNAME, FATHER_NAME, EMAIL, TELEFONE_NUMBER, INFORMATION, PRIKAZ) VALUES
